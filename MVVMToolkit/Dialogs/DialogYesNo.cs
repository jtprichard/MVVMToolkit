...
namespace PB.MVVMToolkit.Dialogs
{
    ...
    public class DialogYesNo : DialogViewModelBase
    {
        ...
        private static string _imagePath = "pack://application:,,,/PB.MVVMToolkit;component/Dialogs/Images/";
        /// <summary>
        ...
        private DialogYesNo(string message, string caption, DialogImage image)
        {
            Message = message;
            Caption = caption;
            ImageFile = SelectImage(image);
        ...
        private string SelectImage(DialogImage image)
        {
            switch (image)
            {
