...
namespace PB.MVVMToolkit.Dialogs
{
    ...
    public class DialogMultiInputOkCancel : BaseDialogViewModel
    {
        ...
        public DialogMultiInputOkCancel(string message, string caption, string defaultAnswer = "", DialogImage image = DialogImage.None)
        {
            Message = message;
            Caption = caption;
        ...
        public DialogMultiInputOkCancel(string message, string caption)
        {
            Message = message;
            Caption = caption;
            Answer = "";
        ...
        public DialogMultiInputOkCancel(string message, string caption, DialogImage image)
        {
            Message = message;
            Caption = caption;
            Answer = "";
        ...
        public DialogMultiInputOkCancel(string message, ObservableCollection<DialogInput> inputs)
        {
            Message = message;
        ...
        {
            var vm = new DialogMultiInputOkCancel(message, caption, defaultAnswer, image);
            vm.Show();
            answer = vm.Answer;
            return vm.Result;
        }
        ...
        {
            var vm = new DialogMultiInputOkCancel(message, caption, "", DialogImage.None);
            vm.Show();
            answer = vm.Answer;
            return vm.Result;
        }
        ...
        {
            var vm = new DialogMultiInputOkCancel(message, caption, defaultAnswer, DialogImage.None);
            vm.Show();
            answer = vm.Answer;
            return vm.Result;
        }
        ...
        {
            var vm = new DialogMultiInputOkCancel(message, caption, "", image);
            vm.Show();
            answer = vm.Answer;
            return vm.Result;
        }
